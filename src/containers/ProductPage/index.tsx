      ...
      <div className="content">
        ...
        <div className="description">
          ...
          <div className="buttons">
            <div><Button text={"Buy Now"} className="large-btn invert-colors"/></div>
            <div><Button text={"Make Offer"} className="large-btn"/></div>
            <div><Button text={"Pivot"} className="large-btn" icon={<div className="question-icon">?</div>}/></div>
          </div>
        </div>
      </div>
    </div>
